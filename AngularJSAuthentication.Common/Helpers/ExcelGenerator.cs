...
namespace AngularJSAuthentication.Common.Helpers
{
    public class ExcelGenerator
    {
        ...
        public static bool DataTable_To_Excel(DataTable pDatos, string sheetname, string pFilePath)
        {
            bool result = false;
            try
            {
        ...
        private static DataTable Excel_To_DataTable(string pRutaArchivo, int pHojaIndex)
        {
            // --------------------------------- //
            /* REFERENCIAS:
             * NPOI.dll
